...
class Generatekmlservice
{
	...
	function __construct(Getcsvdataapi $AppServiceCsvfunction){
        $this->Fldrpth = 'drrmis.info/public/contour/';
        $this->pthTmp = 'drrmis.info/public/contour/csvtemplate/';
    ...
    public function checkmncipltyKml(){
        ...
        foreach ($sensors as $sensor) {            
            $sensordata[$x++] = [
                ...
                'sCum' => $this->AppServiceCsvfunction->getaccum($this->todaypath,$sensor->assoc_file),
                'sID' => $sensor->id,
                'sLoc' => $sensor->address,
                'totalsCum' => 0,
                'count' => 0
