	...
	<center>
		<div id="main-body" class="well">
			...
			<label class="char-count"><span id="character-count">0/160</span></label>
	  		<textarea id="msg" name="msg" class="form-control" rows="5" cols="50" 
					     			...
					     			@foreach($users as $user)
					     				@if($user->id == $subscriber->user_id)
					     					<a href="#" class="list-group-item">
				        						...
				        						<center>													
													<img class="img-settings" src="../uploads/avatars/{{ $user->profile_img }}" 
														 height="40" width="40">
    	...
    	<div class="modal-content">
    	  	...
    	  	<div class="modal-body">
				<div class="alert alert-success">
					<h3>
						<strong>Success!</strong> <span id="success-count"></span>
					</h3>
				</div>
    	  	</div>
    	  	<div class="modal-footer">
