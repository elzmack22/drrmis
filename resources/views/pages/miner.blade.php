    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            ...
            <div class="col-xs-12 np">
                <input class ="btn btn-updatelocation"  type ="submit" value="Run Miner">
            </div>
            </form>
        </div>
        <div class="col-xs-12">
            <form  id="geneform" action="{{ action('IncidentsController@generateKml') }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="col-xs-12 np">
                <input class ="btn btn-updatelocation"  type ="submit" value="Generate Slug">
            </div>
            </form>
        </div>
