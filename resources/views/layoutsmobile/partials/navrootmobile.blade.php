...
<nav id="mainmenus" class="mobilenav hidden-sm hidden-lg hidden-md" role="navigation">
    <ul>
        ...
        <li><span>Warn</span>
            <ul>
                <li>
                    <a href="{{ action("SMSController@viewRegisteredContacts") }}">Subscribers </a>
                </li>
                <li>
                    <a href="{{ action("SMSController@viewManualSMS") }}">Send Manual SMS </a>
                </li>
                <li>
                    <a href="{{ action("SMSController@viewAllNotifications") }}">All Notifications </a>
                </li>
            </ul>
        </li>  
        <li><span>Libraries</span>
            <ul>
                <li>
                    <a href="{{ action("SensorsController@viewSensor") }}">Sensors</a>
                </li>
                <li><span>Threshold</span>
                    <ul>
                        <li>                           
                ...
                <li>
                    <a href="{{action('HazardmapsController@viewHazardmaps')}}">Hazard Maps</a>
                </li> 
                <li>
                    <a href="{{action("FloodproneareasController@viewFloodproneAreas")}}">Flood-prone Areas</a>
                </li>
                <li>
                    <a href="{{ action("CategoriesController@viewCategories") }}">Categories</a>
                </li>
            </ul>
        </li>
        <li><span>Users</span>
            <ul>
                <li>
                    <a href="{{ action("UserController@viewusers") }}">View Users</a>
                </li>
                <li>
                    <a href="{{ action("UserController@viewadduser") }}">Add Users</a>
                </li>
            </ul>
        </li>
