<!-- Navigation -->
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top hidden-xs" role="navigation" id="innerNav">
                    ...
                    <li>
                        ...
                        <ul id="sms-module" class="collapse" aria-expanded="true">
                            ...
                            <li>
                                ...
                                <a href="{{ action("SMSController@viewManualSMS") }}"><i class="glyphicon glyphicon-comment" aria-hidden="true"></i> Send Manual SMS </a>
					...
					<li>
                        ...
                        <ul id="data" class="collapse" aria-expanded="true">
                            ...
                            <li>
                                ...
                                <a href="{{ action("SensorsController@viewSensor") }}"><i class="fa fa-lg  fa-map-marker" aria-hidden="true"></i> Sensors</a>
                            ...
                            <li>
                                <a href="{{ action("SusceptibilityController@viewSusceptibility") }}"><i class="fa fa-linode" aria-hidden="true"></i> Susceptibility</a>                             

                            </li> 
                            <li >
                                <a href="{{ action('TyphoontrackController@viewTyphoonTracks') }}"><i class="fa fa-road" aria-hidden="true"></i> Typhoon Tracks</a>                             
                            ...
                            <li>
                                ...
                                <a href="{{action('HazardsController@viewHazards')}}"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Hazards</a>

                            </li> 

                            <li>

                                <a href="{{action("FloodproneareasController@viewFloodproneAreas")}}"><i class="fa fa-files-o" aria-hidden="true"></i> Flood-prone Areas</a>
                            ...
                            <li>
                                ...
                                <a href="{{ action("CategoriesController@viewCategories") }}"><i class="fa fa-list" aria-hidden="true"></i> Categories</a>
