...
<body class="innerbody">   
    ...
    <div id="wrap-main">
        <aside class="top-wrap hidden-xs">
            @include('layouts.partials.loginform')
            @include('layouts.partials.banner')
            @include('layouts.partials.homenavigation')
        </aside>
        <aside class="top-wrap top-wrapmobile visible-xs hidden-lg hidden-sm hidden-md">
            @include('layouts.partials.banner')
            @include('layoutsmobile.partials.homepagemobilenavigations')
        </aside>
        <aside class="map">
            @yield('left-section')  
